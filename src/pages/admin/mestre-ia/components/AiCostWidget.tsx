...
import { Coins, Pencil, ShieldAlert, Users, UserCog, Robot, Film, FileText, Image } from '../../../../components/Icons';
        ...
        <Card className={`p-6 border ${isBlocked ? 'border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.3)]' : 'border-gray-700'} bg-gray-800 relative overflow-hidden shadow-2xl transition-all duration-300`}>
             ...
             <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
                 ...
                 <div className="lg:col-span-1 flex flex-col justify-center">
                     ...
                     {isWarning && !isBlocked && (
                         <div className="mt-2 text-center text-xs text-yellow-500 font-bold bg-yellow-500/10 p-2 rounded border border-yellow-500/20">
                             ⚠️ Atenção: 95% do crédito consumido.
                         </div>
                     )}
                     {isBlocked && !usageLimit.emergency_stop && (
                         <div className="mt-2 text-center text-xs text-red-500 font-bold bg-red-500/10 p-2 rounded border border-red-500/20">
                             ⛔ Limite atingido. IAs bloqueadas até dia 1º.
                         </div>
                     )}
                 </div>
