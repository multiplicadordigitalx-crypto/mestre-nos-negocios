...
import {
    ...
    Save, RefreshCw, ChevronDown, ChevronRight, Settings, DollarSign, Wallet, ActivityIcon
                    ...
                    <div className="flex bg-gray-900 p-1 rounded-2xl border border-gray-700 mb-8">
                        {(['basic', 'pro', 'elite'] as const).map(tier => (
                            <button
                                ...
                                className={`flex-1 py-4 rounded-xl text-xs font-black uppercase transition-all flex items-center justify-center gap-2 ${activeTier === tier
                    ...
                    <div className="space-y-8 relative z-10">
                        <div className="bg-black/40 p-5 rounded-3xl border border-gray-700">
                            ...
                            <p className="text-[10px] text-gray-400 mt-3 flex items-center gap-2">
                                ...
                                <ActivityIcon className="w-3 h-3 text-brand-primary" /> Análise baseada em {currentPlan.activeFeatures.length} recursos.
                            </p>
                        </div>
