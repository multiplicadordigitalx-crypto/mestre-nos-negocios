...
export const CombosTab: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        const comboToSave: CreditCombo = {
            ...
            stripePriceId: (currentCombo as any).stripePriceId || '',
            stripePaymentLink: (currentCombo as any).stripePaymentLink || ''
        };
                                                ...
                                                <div className="space-y-1 pl-2">
                                                    {module.tools.map(tool => {
                                                        ...
                                                        return (
                                                            <label
                                                                key={tool.id}
                                                                className={`flex items-center justify-between p-2 rounded-lg border cursor-pointer transition-all ${isSelected ? 'bg-orange-500/10 border-orange-500/40 text-white' : 'bg-gray-800/50 border-gray-700 text-gray-500 hover:bg-gray-800 hover:border-gray-600'
                                                                    }`}
                                                            >
