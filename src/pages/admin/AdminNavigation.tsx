...
export type AdminView = 'dashboard' | 'app_products' | 'requests' | 'influencers' | 'sales_team' | 'verification' | 'levels' | 'chat' | 'refunds' | 'access_recovery' | 'financial' | 'team' | 'productivity' | 'audit' | 'evolution' | 'settings' | 'commissions';
...
const AdminNavigation: React.FC<AdminNavigationProps> = ({ currentView, setCurrentView, pendingCount, isSuperAdmin }) => {
        ...
        <div className="flex flex-wrap gap-2 bg-gray-800 p-1 rounded-lg overflow-x-auto max-w-full custom-scrollbar mb-6 border border-gray-700">
            ...
            {isSuperAdmin && (
                <>
                    ...
                    <NavButton view="evolution" label="WhatsApp API" icon={<Smartphone className="w-4 h-4" />} />
