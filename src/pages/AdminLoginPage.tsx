...
const AdminLoginPage: React.FC<AdminLoginPageProps> = ({ onSwitchToStudent, onSupportLoginSuccess, onForgotPassword }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const isCorporateDomain =
            email.endsWith('@mestredosnegocios.com') ||
            email.endsWith('@mestrenosnegocios.com') ||
            email.endsWith('@mestredosnegocios.com.br') ||
            email === 'mestrodonegocio01@gmail.com';

        if (!isTeamMember && !isCorporateDomain && !isAdminEmail) {
