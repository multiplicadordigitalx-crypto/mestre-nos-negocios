...
import {
    PlusCircle, Trash, BookOpen, ArrowLeft, HeartPulse,
...
const NICHOS_BY_CATEGORY: Record<string, string[]> = {
    all: [
        ...
        "Idiomas", "Gastronomia & Culinária", "Moda & Beleza", "Esportes & Fitness",
        "Artes & Design", "Negócios & Carreira", "Espiritualidade", "Outros"
    ],
    standard: [
