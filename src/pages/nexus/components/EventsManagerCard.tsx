...
import { Activity, AlertTriangle, CheckCircle, MessageCircle, Mail, ShieldCheck } from '../../../components/Icons';
             ...
             <div className="p-6 border-b border-gray-800 flex justify-between items-center bg-gray-900/90 relative z-10">
                 <div>
                    <h3 className="text-lg font-bold text-white uppercase tracking-wider flex items-center gap-2">
                        <Activity className="w-5 h-5 text-purple-500 animate-pulse"/> Gerenciador de Eventos
                    </h3>
                             ...
                             >
                                 <div className="flex items-center gap-3">
                                     <div className={`p-2 rounded-lg border ${
                                         evt.status === 'success' ? 'bg-green-500/10 border-green-500/30 text-green-500' :
