...
import { ActivityIcon, RefreshCw } from '../../../components/Icons';
...
export const StrategiesTab: React.FC = () => {
    return (
        <div className="space-y-4 md:space-y-6 animate-fade-in">
            ...
            <div className="bg-gray-800 p-4 md:p-5 rounded-xl border border-gray-700 shadow-lg flex flex-col md:flex-row justify-between gap-4 md:gap-6">
                <div className="flex-1">
                    <h3 className="font-bold text-white text-lg mb-2 flex items-center gap-2">
                        <ActivityIcon className="w-5 h-5 text-brand-primary" /> Análise de Fluxo (Autônoma)
                    </h3>
