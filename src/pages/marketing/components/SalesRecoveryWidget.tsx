...
import { RotateCcw, Settings, Clock, Trash, Brain, Activity, CheckCircle, X as XIcon } from '../../../components/Icons';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
                ...
                <div className="lg:col-span-2 bg-gray-900 rounded-xl border border-gray-700 flex flex-col h-[400px]">
                    <div className="p-4 border-b border-gray-700 flex justify-between items-center bg-gray-800/50 rounded-t-xl">
                        <h4 className="text-sm font-bold text-white flex items-center gap-2"><Activity className="w-4 h-4 text-green-500"/> Fila de Processamento em Tempo Real</h4>
