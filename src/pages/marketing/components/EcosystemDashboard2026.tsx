...
import { DollarSign, TrendingUp, Users, Zap, MessageSquare, ActivityIcon, Phone, Layers, Mail, Brain } from '../../../components/Icons';
                ...
                <Card className="lg:col-span-2 p-6 bg-gray-800 border-gray-700">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-lg font-bold text-white flex items-center gap-2">
                            <ActivityIcon className="w-5 h-5 text-brand-primary" /> Performance por Canal (24h)
                        </h3>
