...
import { Student, StudentPage } from '../types';
...
export const StudentHeader: React.FC<HeaderProps> = ({ goBack, canGoBack = false, navigateTo }) => {
  ...
  return (
    <header className="flex flex-row justify-between items-center px-4 py-3 md:p-5 bg-gray-900/50 backdrop-blur-xl border-b border-gray-800 relative z-40 rounded-b-[1.5rem] md:rounded-b-[2rem] shadow-2xl">
      ...
      <div className="flex items-center gap-3 md:gap-8 justify-end shrink-0" ref={dropdownRef}>
        ...
        {/* Student Specific: Credits (Desktop) */}
        <div className="hidden lg:block text-right">
             <p className="text-brand-primary font-black text-sm tracking-tight leading-none mb-1">{mockCredits} CRÉDITOS</p>
             <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest">Investimento IA</p>
        </div>
                    ...
                    <div className="p-5 space-y-5">
                        ...
                        <div className="space-y-2">
                             ...
                             <button 
                                 ...
                                 className="w-full py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-purple-900/20 flex items-center justify-center gap-2"
                             >
